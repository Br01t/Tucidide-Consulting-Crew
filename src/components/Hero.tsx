...
const Hero = () => {
  return (
    <section id="agora" className="relative h-screen min-h-[700px] flex items-center overflow-hidden pt-24">
      <div className="container mx-auto px-12 relative z-10 grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-20 items-center">
        ...
        <div className="relative z-10">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-serif font-black leading-none mb-4 tracking-wider uppercase text-white">
              Tucidide<br/>Consulting<br/>Crew
            </h1>
            
            <p className="text-sm md:text-base tracking-[0.4em] font-light text-azure mb-12 uppercase">
            ...
            <div className="flex flex-wrap gap-6">
              <Link 
                to="/contatti"
                className="cta-gradient text-obsidian font-bold uppercase tracking-[0.2em] px-10 py-5 rounded-sm text-xs hover:scale-105 transition-transform cursor-pointer"
              >
                Inizia la Collaborazione
              </Link>
              <Link 
                to="/vision"
                className="border border-white/20 text-white font-bold uppercase tracking-[0.2em] px-10 py-5 rounded-sm text-xs hover:bg-white/10 transition-colors cursor-pointer"
              >
                Scopri la Vision
              </Link>
            </div>
